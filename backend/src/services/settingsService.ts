      ...
      if (!settings) {
        settings = await prisma.globalSettings.create({
          data: {
            ...
            evolutionHost: '',
            evolutionApiKey: '',
            companyName: 'BTW Data Company',
            pageTitle: 'BTW Data Company - Gestão de Campanhas',
      ...
      if (settings) {
        ...
        settings = await prisma.globalSettings.create({
          data: {
            ...
            companyName: data.companyName || 'BTW Data Company',
            faviconUrl: data.faviconUrl || '/api/uploads/default_favicon.png',
            pageTitle: data.pageTitle || 'BTW Data Company - Gestão de Campanhas',
