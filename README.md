# 🚀 BTW Data Company - Plataforma SaaS Multi-Tenant para Campanhas WhatsApp
...
1. **AcAcesse o sistema: `http://localhost` ou `https://gestao.btwdata.tech`
2. **Login padrão SUPERADMIN: `superadmin@btwdata.tech` / `Admin123`3`
3. **LLogin padrão ADMIN: `admin@btwdata.tech` / `Admin123``
